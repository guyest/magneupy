...
setup(
    ...
    packages=['.venv.lib.python3.6.distutils', '.venv.lib.python3.6.encodings', '.venv.lib.python3.6.importlib',
              ...
              '.venv.lib.python3.6.site-packages.wheel', '.venv.lib.python3.6.site-packages.wheel.test',
              ...
              '.venv.lib.python3.6.site-packages.pkg_resources._vendor.packaging', 'neupy', 'neupy.rep', 'neupy.data',
              'neupy.helper', 'neupy.crystal'],
